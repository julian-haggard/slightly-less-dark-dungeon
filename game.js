...
function preload ()
{
    ...
    var myplayer = this.load.spritesheet('player1', 'img/Character Spritesheet (1).gif', {frameWidth: 16, frameHeight: 16});
...
function create ()
{
    ...
    player = this.add.sprite(map.tileWidth * layer.scaleX, map.tileHeight * layer.scaleY, 'player1');
                    this.anims.create({
                        key : "left",
                        frames : this.anims.generateFrameNumbers('player1', {start:9, end:12}),
                        frameRate: 10,
                        repeat : -1
                    })
                    this.anims.create({
                        key : "down",
                        frames : this.anims.generateFrameNumbers('player1', {start: 1, end : 4}),
                        frameRate : 10,
                        repeat: -1
                    })
                    this.anims.create({
                    ...
                    this.anims.create({
                        key : "right",
                        frames : this.anims.generateFrameNumbers('player1', {start:13, end:16}),
                        frameRate: 10,
                        repeat : -1
                    });
